...
public static class ReceiptGenerator
{
    ...
    public static string GenerateContributionText(TripConfig trip, string memberSlug, Transaction? contribution, List<Transaction> allTransactions)
    {
        ...
        if (!memberContributions.Any())
        {
            sb.AppendLine("Nessun versamento registrato");
        }
        else
        {
