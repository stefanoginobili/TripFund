...
- **Summary:** Large display of the Total Remaining Balance (Totale rimasto) and, slightly smaller, the Total Contributed (Totale versato) in the selected currency.
