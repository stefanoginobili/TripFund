...
3. Implement the core C# Models (`TripConfig`, `Transaction`, `User`, `LocalTripRegistry`, `TripReference`) exactly matching the JSON structures defined in `SCHEMAS.md`. Use string `slugs` as dictionary keys for users.
